...
struct mafAli* pre_yama(struct mafAli *a1, struct mafAli* a2, int beg, int end,int radius, int v, FILE* fpw2, struct mafAli*** t) {
    ...
    if ( K==0 ) {
        if (fpw2 != NULL)
        {
            nali = make_part_ali_col(a2, cbeg2, cend2);
            if (nali != NULL)
...
struct mafAli* pre_yama0(struct mafAli* a1, struct mafAli* a2, int beg, int end, int radius, int v, FILE* fpw2, struct mafAli** t) {
    int cbeg1, cend1, cbeg2, cend2, M, N, K, L, i, j, M_new, M3, N3;
    int* LB, * RB, * LB2, * RB2;
    uchar** A, ** B, ** AL_new, ** AL_new2, ** A2, ** B2;
    struct mafComp* comp;
...
struct mafAli* pre_yama2(struct mafAli* a1, struct mafAli* a2, struct mafAli* a3, int beg1, int end1, int begN, int endN, int radius, struct pwuAliFiles* pws) {
    ...
    struct mafAli *val = NULL;
    struct mafComp *c = NULL, *c1=NULL, *c2 = NULL, *c3 = NULL, *d = NULL;
    int cbeg1, cend1, cbeg2, cend2, cbeg3, cend3, i, j, k,
    M, N, K, L, M_new, *LB, *RB;
    uchar **A = NULL, **B = NULL, **AL_new, x, y, z;
